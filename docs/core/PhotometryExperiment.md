...
**This class is used to process and slice photometry experiments into trials, with support for both dual and single channel experiments.**
...
# trial-wise PhotometryData is stored in .trial_data
trials = exp.trial_data
```

**Visualization**
```python
# plot both raw and processed traces
exp.plot_dashboard(raw=True)
